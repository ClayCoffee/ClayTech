...
public class Drinks {
	public Drinks() {
		...
		ItemStack[] recipec = { null, ClayTechItems.TEA_POWDER, null, null, ClayTechItems.TEA_POWDER, null, null,
				ClayTechItems.DRINK_BOTTLE, null };
		ItemStack[] reciped = { null, ClayTechItems.TEA_POWDER, null, ClayTechItems.LEMON_POWDER, ClayTechItems.TEA_POWDER,
				ClayTechItems.LEMON_POWDER, null, ClayTechItems.DRINK_BOTTLE, null };
		...
		Slimefunutils.registerItem(ClayTechItems.C_DRINK, "LEMON_POWDER_DRINK", ClayTechItems.LEMON_POWDER_DRINK, "notresearch", 10,
		...
		Slimefunutils.registerItem(ClayTechItems.C_DRINK, "LEMON_TEA_DRINK", ClayTechItems.LEMON_TEA_DRINK, "notresearch", 10,
		...
		foodI.addItems(SlimefunItem.getByItem(ClayTechItems.CLAY_COFFEE), SlimefunItem.getByItem(ClayTechItems.LEMON_POWDER_DRINK),
