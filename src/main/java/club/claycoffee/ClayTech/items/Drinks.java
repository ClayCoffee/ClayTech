...
public class Drinks {
	public Drinks() {
		ItemStack[] recipea = { null, Defines.COCOA_BEAN, null, null, Defines.COCOA_BEAN, null, null,
				Defines.DRINK_BOTTLE, null };
		ItemStack[] recipeb = { null, Defines.LEMON_POWDER, null, null, Defines.LEMON_POWDER, null, null,
				Defines.DRINK_BOTTLE, null };
		ItemStack[] recipec = { null, Defines.TEA_POWDER, null, null, Defines.TEA_POWDER, null, null,
				Defines.DRINK_BOTTLE, null };
		ItemStack[] reciped = { null, Defines.TEA_POWDER, null, Defines.LEMON_POWDER, Defines.TEA_POWDER,
				Defines.LEMON_POWDER, null, Defines.DRINK_BOTTLE, null };
		...
		foodI.addItems(SlimefunItem.getByItem(Defines.CLAY_COFFEE), SlimefunItem.getByItem(Defines.LEMON_POWDER_DRINK),
				SlimefunItem.getByItem(Defines.TEA_DRINK), SlimefunItem.getByItem(Defines.LEMON_TEA_DRINK));
		foodI.register();
	}
}
