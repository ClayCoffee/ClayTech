...
public class Foods {
	public Foods() {
		Slimefunutils.registerItem(ClayTechItems.C_FOOD, "CHICKEN_FOOT", ClayTechItems.CHICKEN_FOOT, "notresearch", 10,
				TRecipe.CLAY_FOOD_CAULDRON, Recipes.CHICKEN_FOOT, false);
		Slimefunutils.registerItem(ClayTechItems.C_FOOD, "SPICY_CHICKEN_BURGER", ClayTechItems.SPICY_CHICKEN_BURGER, "notresearch",
				10, TRecipe.CLAY_FOOD_CAULDRON, Recipes.SPICY_CHICKEN_BURGER, false);
		Slimefunutils.registerItem(ClayTechItems.C_FOOD, "BABA_BURGER", ClayTechItems.BABA_BURGER, "notresearch", 10,
				TRecipe.CLAY_FOOD_CAULDRON, Recipes.BABA_BURGER, false);
		Slimefunutils.registerItem(ClayTechItems.C_FOOD, "CHOCOLATE", ClayTechItems.CHOCOLATE, "notresearch", 10,
				TRecipe.CLAY_FOOD_CAULDRON, Recipes.CHOCOLATE, false);
		Slimefunutils.registerItem(ClayTechItems.C_FOOD, "SNAIL_BAD", ClayTechItems.SNAIL_BAD, "notresearch", 10, RecipeType.NULL,
		...
		Slimefunutils.registerItem(ClayTechItems.C_FOOD, "SNAIL_FOOD", ClayTechItems.SNAIL_FOOD, "notresearch", 10,
				TRecipe.CLAY_FOOD_CAULDRON, Recipes.SNAIL_FOOD, false);
		Slimefunutils.registerItem(ClayTechItems.C_FOOD, "COOKED_SWEET_POTATO", ClayTechItems.COOKED_SWEET_POTATO, "notresearch", 10,
				TRecipe.CLAY_FOOD_CAULDRON, Recipes.COOKED_SWEET_POTATO, false);
		...
		foodI.addItems(SlimefunItem.getByItem(ClayTechItems.CHICKEN_FOOT),
				...
				SlimefunItem.getByItem(ClayTechItems.CHOCOLATE), SlimefunItem.getByItem(ClayTechItems.SNAIL_BAD),
				SlimefunItem.getByItem(ClayTechItems.SNAIL_FOOD));
		foodI.register();
		...
		if (ClayTech.is115) {
			...
			foodII.addItems(SlimefunItem.getByItem(ClayTechItems.HONEY_SWEET),SlimefunItem.getByItem(ClayTechItems.SWEET_POTATO),SlimefunItem.getByItem(ClayTechItems.COOKED_SWEET_POTATO));
			foodII.register();
		}
		else {
			Research foodII = new Research(new NamespacedKey(ClayTech.plugin, "CLAYTECH_FOODBASIC2"), 9916,
					Lang.readResearchesText("CLAYTECH_FOOD_II"), 50);
			foodII.addItems(SlimefunItem.getByItem(ClayTechItems.SWEET_POTATO),SlimefunItem.getByItem(ClayTechItems.COOKED_SWEET_POTATO));
			foodII.register();
		}
