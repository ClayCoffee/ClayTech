...
public class FoodMakingStaff {
	public FoodMakingStaff() {
		...
		ItemStack[] recipec = { null, new ItemStack(Material.BREAD), null, null, Defines.MAGIC_CLAY, null, null,
				new ItemStack(Material.BREAD), null };
		ItemStack[] reciped = { null, new ItemStack(Material.KELP), null, null, Defines.MAGIC_CLAY, null, null,
				new ItemStack(Material.BAMBOO), null };

		Slimefunutils.registerItem(Defines.C_FOODMATERIALS, "RAW_CHICKEN_FOOT", Defines.RAW_CHICKEN_FOOT, "notresearch",
		...
		Slimefunutils.registerItem(Defines.C_FOODMATERIALS, "LEMON", Defines.LEMON, "notresearch", 10, RecipeType.NULL,
		...
		Slimefunutils.registerItem(Defines.C_FOODMATERIALS, "FLOUR", Defines.FLOUR, "notresearch", 10, RecipeType.NULL,
				Defines.NORECIPE, false);
		...
		foodmaterialsI.addItems(SlimefunItem.getByItem(Defines.RAW_CHICKEN_FOOT),
				SlimefunItem.getByItem(Defines.RAW_BREAD), SlimefunItem.getByItem(Defines.RAW_VEGETABLE));
		...
		foodmaterialsIE.addItems(SlimefunItem.getByItem(Defines.FLOUR), SlimefunItem.getByItem(Defines.STARCH),
				SlimefunItem.getByItem(Defines.SNAIL_HEALTHY));
